  ...
  return (
    <div id="main">
      <img
        ...
        src="https://images.pexels.com/photos/3527786/pexels-photo-3527786.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      ></img>
      <div className="w-full h-screen absolute top-0 left-0 bg-white/60">
        <div className="m-auto h-full w-full flex flex-col justify-center items-center">
          ...
          <div className="flex justify-between pt-6 max-w-[200px] w-full">
            <a href="https://www.linkedin.com/in/damien-rat/" target="blank">
              <FaLinkedin className="cursor-pointer" size={20} />
            </a>
            <a href="https://github.com/DamienCode404" target="blank">
              <FaGithub className="cursor-pointer" size={20} />
            </a>
            <a href="https://twitter.com/damir_code" target="blank">
